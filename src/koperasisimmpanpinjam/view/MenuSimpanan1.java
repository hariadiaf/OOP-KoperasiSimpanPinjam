 ...
 */
public class MenuSimpanan1 extends javax.swing.JFrame {

    /**
     * Creates new form MenuSimpanan1
     */
    public MenuSimpanan1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuSimpanan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuSimpanan1().setVisible(true);
            }
        });
    }
